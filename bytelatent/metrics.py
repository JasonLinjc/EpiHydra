...
class LoggingArgs(BaseModel):
    ...
    acc_freq: int = None  # Log every acc_freq gradient accumulation steps

    wandb: WandbArgs = None


class MetricLogger:
    def __init__(self, outdir: Path, args: Any = None):
        self.outdir = outdir
