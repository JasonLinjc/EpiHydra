...
def parse_ngram_to_size(ngram_to_size_str: str) -> dict[int, int]:
...
class ByteLatentTransformerArgs(BaseTransformerArgs):
    ...
    max_encoder_seq_length: int = 200
    pad_to_max_length: bool = False
    encoder_enable_byte_ngrams: bool = False
    encoder_enable_byte_group_hash: bool = False
    ngram_vocab_sizes: int = None

    # Cross attention configurations
    cross_attn_encoder: bool = True
    cross_attn_decoder: bool = False
    cross_attn_window_encoder: int = None
    cross_attn_window_decoder: int = None
    cross_attn_k: int = 1
    cross_attn_nheads: int = 8
    ...
    encoder_hash_byte_group_size: Any = [3]
    encoder_hash_byte_group_vocab: int = 127
    ...
    global_local_decoder_residual_layer: str = None

    tokenize_with_bpe_delimiter: bool = False
    patching_thresholds_str: str = None
    tie_local_encoder_decoder: bool = False
    encoder_preds_low_entropy_toks: float = None
    encoder_preds_random_toks: float = None
    dim_token_emb: int = 256
    dim_patch_emb: int = 256

    encoder_ngram_table_dir: str = None
    encoder_ngram_to_size_str: str = None

    # Model architecture params
    entropy_model_checkpoint_dir: str = None
    entropy_model_is_ngram_model: bool = False
    downsampling_by_pooling: str = 'avg'
    n_heads_global: int = 8
    n_heads_local_decoder: int = 8
    n_heads_local_encoder: int = 8
    n_kv_heads: int = None
    n_kv_heads_global: int = None
    conv_kernel_size: int = None
    local_attention_window_len: int = None
